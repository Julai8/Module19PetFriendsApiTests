...
class PetFriends:
    ...
    def get_api_key(self, email: str, passwd: str) -> json:
        ...
        статус запроса и результат в формате JSON с уникальным ключем 
    ...
    def add_new_pet(self, auth_key: json,
        ...
        """Метод отправляет (постит) на сервер данные о добавляемом питомце и
    ...
    def add_foto_of_pet(self,
        ...
        - фото - по указанному ID
        и возвращает статус запроса и result в формате JSON
        с обновлённыи данными питомца.
        Здесь отрабатывается POST API запрос."""
